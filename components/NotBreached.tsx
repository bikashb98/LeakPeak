...
export function NotBreached () {
    return (
        <div className="flex flex-col justify-center full font-headland ">
            ...
            <div className="flex flex-col border-2 my-4 justify-center rounded h-50 border-green-700 bg-green-300/45">
                <div className="flex justify-center font-extrabold text-3xl text-green-500/75">
                    0
                </div>
                <div className="flex justify-center py-4 font-extrabold text-3xl text-green-500/75">
                    Data Breaches
                </div>
